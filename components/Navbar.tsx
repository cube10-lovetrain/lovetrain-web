      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center h-[80px] py-5">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a href="#" className="text-[18px] text-gray-700 hover:text-[#ff9f1c] transition duration-300">Explore</a>
            <a href="#" className="text-[18px] text-gray-700 hover:text-[#ff9f1c] transition duration-300">About</a>
          </div>
